...
Git を使わずに、直接ファイルをコピーしてください。

---

## ✅ **方法：テキストエディタでファイルを作成**

### **Step 1: メモ帳またはVSCodeを開く**

```powershell
# メモ帳で開く場合
notepad E:\anonymous-keiba-ai-JRA\phase7\scripts\phase7b_factor_roi\create_merged_dataset_334cols.py
```
...
```powershell
# VSCodeで開く場合
code E:\anonymous-keiba-ai-JRA\phase7\scripts\phase7b_factor_roi\create_merged_dataset_334cols.py
```

---

### **Step 2: 以下の内容を全てコピー＆ペースト**
...
- **エンコーディング**: UTF-8
- **保存先**: `E:\anonymous-keiba-ai-JRA\phase7\scripts\phase7b_factor_roi\create_merged_dataset_334cols.py`
