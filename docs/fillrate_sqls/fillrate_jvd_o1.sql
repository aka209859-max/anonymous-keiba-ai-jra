...
SELECT
    ...
    COUNT(odds_tansho) AS cnt_odds_tansho,
    ROUND(COUNT(odds_tansho)::NUMERIC / COUNT(*) * 100, 2) AS rate_odds_tansho,
    COUNT(odds_fukusho) AS cnt_odds_fukusho,
    ROUND(COUNT(odds_fukusho)::NUMERIC / COUNT(*) * 100, 2) AS rate_odds_fukusho,
    COUNT(odds_wakuren) AS cnt_odds_wakuren,
    ROUND(COUNT(odds_wakuren)::NUMERIC / COUNT(*) * 100, 2) AS rate_odds_wakuren,
